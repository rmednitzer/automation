...
- Enables the `sshd` jail with a 3-attempt limit by default
- Uses `systemd` as the log backend (journal-based, no
...
will protect port 22 while sshd listens elsewhere.
