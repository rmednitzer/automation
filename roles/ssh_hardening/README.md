...
- Disables password authentication and keyboard-interactive by default
  (key-only — POL-001)
...
- Selects BSI TR-02102-4 / Mozilla-modern aligned KEX, ciphers, MACs,
  and host-key algorithms (POL-003 — no SHA-1, no CBC, Ed25519 preferred)
- Configures session timeouts, max auth attempts, and disables agent /
